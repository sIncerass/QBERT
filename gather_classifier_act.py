...
def run_classifier_w_args(args):
    ...
    if args.do_train:
        ...
        import copy
        for name, layer in model.module.bert.encoder.layer._modules.items():
            # output module has layernorm, and dropout is not considered
            # if name is 'output' or name is 'dropout' or name is 'layernorm':
            #     continue
        ...
        for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
            ...
            activation = {}
        import pickle
        outfile = open(os.path.join(args.output_dir, 'activations'), 'wb')
