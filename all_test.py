...
def schedule_run(output_dir,
    ...
    # block_wise_bits = [3] * 12
    # block_wise_bits = [2] * 12



    # HAWQ 2-bit
    # NER
    # block_wise_bits = [2, 3, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2]
    # channel-wise best setting
    # block_wise_bits = [2, 3, 3, 3, 3, 2, 2, 2, 2, 2, 2, 2]

    # SST-2
    # block_wise_bits = [2, 2, 2, 3, 3, 3, 3, 3, 3, 2, 2, 2]
    # channel-wise best setting
    # block_wise_bits = [2, 2, 2, 3, 3, 3, 3, 3, 3, 2, 2, 2]
    ...
    # MNLI
    # block_wise_bits = [2, 2, 2, 2, 3, 3, 3, 3, 2, 2, 2, 2]
    # channel-wise best setting
    # block_wise_bits = [2, 2, 2, 2, 3, 3, 3, 3, 2, 2, 2, 2]
    ...
    # HAWQ 3-bit
    # NER
    # block_wise_bits = [2, 4, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2]
    # channel-wise best setting
    # block_wise_bits = [2, 4, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2]

    # MNLI
    # block_wise_bits = [3, 3, 3, 3, 3, 4, 4, 4, 3, 2, 2, 2]
    ...
    quantized_config = BertConfig_generic(
                # quantize_activation, freeze_embedding, block_wise_bits, emb_bits=[6, 8, 32])
