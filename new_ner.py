...
class BertForNer(BertForTokenClassification):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None,valid_ids=None,attention_mask_label=None):
        ...
        for i in range(batch_size):
            ...
            # print(mask_len, valid_output[i].shape, sequence_output[i][ valid_mask_b ].shape)
...
def run_ner_w_args(args):
    ...
    model = BertForNer.from_pretrained(args.bert_model,
              cache_dir=cache_dir, config_dir=args.config_dir,
              num_labels=num_labels, config=args.config)
    ...
    if args.do_train:
        ...
        model = BertForNer.from_pretrained(args.bert_model, num_labels=num_labels)
        tokenizer = BertTokenizer.from_pretrained(args.bert_model, do_lower_case=args.do_lower_case)
    model.to(device)
