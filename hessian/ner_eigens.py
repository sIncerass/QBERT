...
from power_iteration import get_hessian_trace, power_iteration, add_poweriter_arguments, get_trace_family
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="the hessian analysis method. poweriter / trace. (default: poweriter)"
    )
